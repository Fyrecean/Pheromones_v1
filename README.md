...
See it live (Use Chrome, Edge, or Nightly firefox, see [browser compatibility table](https://developer.mozilla.org/en-US/docs/Web/API/WebGPU_API#browser_compatibility)):
https://fyrecean.com/pheromones_v1/

Use the config panel in the top right to adjust the simulation parameters, and the dropdown to save a configuration to your browsers cookies.
